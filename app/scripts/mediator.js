define([
    ...
    var from = function(headerObj) {
        return headerObj && headerObj.from ? headerObj.from : '';
    };
    ...
    return function() {
        ...
        return {
            publish: function(channel, from) {
                /**
                Remove because is ticked off jshint
                var packet = {
                    from: from || ''
                };**/
            ...
            subscribe: function(channel, callback, predicate, context) {
                context = context || {};
                var options = {};
                //var wrappedCallback = function(headerObj) {//js hint
                //was not happy
                ...
                var predFunc = function(headerObj) {
                    return from(headerObj) !== subObj.id;
                };
